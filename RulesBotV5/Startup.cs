...
namespace RulesBotV5
{
    ...
    public class Startup
    {
        ...
        {
            var secretKey = "kBETtuc/Dh4ioAZ54bUzpDyaYX5s8TFFl2jZX01vqcg=";
            var botFilePath =  "./RulesBotV5.bot";
            ...
            var botConfig = BotConfiguration.Load(botFilePath ?? @"./RulesBotV5.bot", secretKey);
            ...
            services.AddBot<RulesBotV5>(options =>
            {
                ...
                ILogger logger = _loggerFactory.CreateLogger<RulesBotV5>();
